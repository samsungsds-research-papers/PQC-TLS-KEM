...
public class BcTlsX25519KyberHybrid implements TlsAgreement
{
    protected final BcTlsX25519KyberHybridDomain domain;
    ...
    public BcTlsX25519KyberHybrid(BcTlsX25519KyberHybridDomain domain)
    {
        this.domain = domain;
    }
