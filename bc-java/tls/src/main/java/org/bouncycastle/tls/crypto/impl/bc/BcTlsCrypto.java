    ...
    extends AbstractTlsCrypto
{
    ...
    public TlsPQCDomain createPQCDomain(TlsPQCConfig pqcConfig)
    {
        ...
        case NamedGroup.secp521Kyber1024:
            return new BcTlsECDHKyberHybridDomain(this, pqcConfig);
        case NamedGroup.x25519Kyber512:
        case NamedGroup.x25519Kyber768:
            return new BcTlsX25519KyberHybridDomain(this, pqcConfig);
        case NamedGroup.x448Kyber768:
            return new BcTlsX448KyberHybridDomain(this, pqcConfig);
        default:
