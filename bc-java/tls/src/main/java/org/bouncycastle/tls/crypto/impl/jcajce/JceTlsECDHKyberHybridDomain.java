...
public class JceTlsECDHKyberHybridDomain implements TlsPQCDomain
{
    protected final JceTlsECDomain ecDomain;
    protected final JceTlsKyberDomain kyberDomain;

    public JceTlsECDHKyberHybridDomain(JcaTlsCrypto crypto, TlsPQCConfig pqcConfig)
    {
    ...
    {
        return new JceTlsECDHKyberHybrid(this);
    }
