...
public class BcTlsECDHKyberHybridDomain implements TlsPQCDomain
{
    protected final BcTlsECDomain ecDomain;
    protected final BcTlsKyberDomain kyberDomain;

    public BcTlsECDHKyberHybridDomain(BcTlsCrypto crypto, TlsPQCConfig pqcConfig)
    {
    ...
    {
        return new BcTlsECDHKyberHybrid(this);
    }
