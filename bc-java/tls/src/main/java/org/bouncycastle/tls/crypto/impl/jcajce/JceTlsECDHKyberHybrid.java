...
public class JceTlsECDHKyberHybrid implements TlsAgreement
{
    protected final JceTlsECDHKyberHybridDomain domain;
    ...
    public JceTlsECDHKyberHybrid(JceTlsECDHKyberHybridDomain domain)
    {
        this.domain = domain;
    }
