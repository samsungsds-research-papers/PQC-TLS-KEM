...
public class JceTlsX448KyberHybridDomain implements TlsPQCDomain
{
    protected final JceTlsKyberDomain kyberDomain;
    protected final JceX448Domain x448Domain;
    protected final JcaTlsCrypto crypto;

    public JceTlsX448KyberHybridDomain(JcaTlsCrypto crypto, TlsPQCConfig pqcConfig)
    {
    ...
    {
        return new JceTlsX448KyberHybrid(this);
    }
