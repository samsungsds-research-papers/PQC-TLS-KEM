...
public class BcTlsX448KyberHybrid implements TlsAgreement
{
    protected final BcTlsX448KyberHybridDomain domain;
    ...
    public BcTlsX448KyberHybrid(BcTlsX448KyberHybridDomain domain)
    {
        this.domain = domain;
    }
