...
public class BcTlsECDHKyberHybrid implements TlsAgreement
{
    protected final BcTlsECDHKyberHybridDomain domain;
    ...
    public BcTlsECDHKyberHybrid(BcTlsECDHKyberHybridDomain domain)
    {
        this.domain = domain;
    }
