...
public class JceTlsX448KyberHybrid implements TlsAgreement
{
    protected final JceTlsX448KyberHybridDomain domain;
    ...
    public JceTlsX448KyberHybrid(JceTlsX448KyberHybridDomain domain)
    {
        this.domain = domain;
    }
