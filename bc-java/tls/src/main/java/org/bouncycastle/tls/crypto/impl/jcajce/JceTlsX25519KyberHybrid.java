...
public class JceTlsX25519KyberHybrid implements TlsAgreement
{
    protected final JceTlsX25519KyberHybridDomain domain;
    ...
    public JceTlsX25519KyberHybrid(JceTlsX25519KyberHybridDomain domain)
    {
        this.domain = domain;
    }
