...
class MockTlsKyberHybridServer
    extends AbstractTlsServer
{
    MockTlsKyberHybridServer()
    {
    ...
    protected int[] getSupportedCipherSuites()
    {
        return TlsUtils.getSupportedCipherSuites(getCrypto(),
            new int[] { CipherSuite.TLS_AES_256_GCM_SHA384 });
    }

    public int[] getSupportedGroups() throws IOException {
        // TODO Auto-generated method stub
        return new int[]{ NamedGroup.secp521Kyber1024, NamedGroup.secp384Kyber768, NamedGroup.secp256Kyber512
            , NamedGroup.kyber1024, NamedGroup.kyber512, NamedGroup.kyber768, NamedGroup.secp521r1
            , NamedGroup.x25519Kyber512, NamedGroup.x25519Kyber768, NamedGroup.x448Kyber768,  NamedGroup.x25519 };
    }
    ...
    public ProtocolVersion getServerVersion() throws IOException
    {
        ...
        System.out.println("TLS kyber hybrid server negotiated " + serverVersion);
    ...
    public void notifyAlertRaised(short alertLevel, short alertDescription, String message, Throwable cause)
    {
        ...
        out.println("TLS kyber hybrid server raised alert: " + AlertLevel.getText(alertLevel)
    ...
    {
        PrintStream out = (alertLevel == AlertLevel.fatal) ? System.err : System.out;
        out.println("TLS kyber hybrid server received alert: " + AlertLevel.getText(alertLevel)
            + ", " + AlertDescription.getText(alertDescription));
    }
